...
import claire.util.math.primitive.VariableSInt;
import claire.util.math.primitive.VariableUInt;
import claire.util.memory.buffer.BufferedOutgoingStream;

public class Test {
	
	public static final int runTests() throws Exception
	{
		int reg = 0;
		...
		reg += KeyDES.test();
		Log.info.println("Testing claire.util.crypto.cipher.key.block.KeyDESX");
		reg += KeyDESX.test();
		Log.info.println("Testing claire.util.crypto.cipher.key.block.KeyTDEA");
		reg += KeyTDEA.test();
		...
		reg += KeyIDEA.test();
		Log.info.println("Testing claire.util.crypto.cipher.key.block.KeyARIA");
		reg += KeyARIA.test();
		Log.info.println("Testing claire.util.crypto.cipher.key.block.KeyCamellia");
		reg += KeyCamellia.test();
		Log.info.println("Testing claire.util.crypto.cipher.key.block.KeySpeck16");
		reg += KeySpeck16.test();
		Log.info.println("Testing claire.util.crypto.cipher.key.block.KeySpeck32");
		reg += KeySpeck32.test();
		Log.info.println("Testing claire.util.crypto.cipher.key.block.KeySpeck64");
		reg += KeySpeck64.test();
		Log.info.println("Testing claire.util.crypto.cipher.key.block.KeySimon16");
		reg += KeySimon16.test();
		Log.info.println("Testing claire.util.crypto.cipher.key.block.KeySimon32");
		reg += KeySimon32.test();
		Log.info.println("Testing claire.util.crypto.cipher.key.block.KeySimon64");
		reg += KeySimon64.test();
		Log.info.println("Testing claire.util.crypto.cipher.key.block.KeyMARS");
		reg += KeyMARS.test();
		Log.info.println("Testing claire.util.crypto.cipher.key.block.KeyThreefish");
		reg += KeyThreefish.test();
		...
		reg += KeyIBAA.test();
		Log.info.println("Testing claire.util.crypto.cipher.key.stream.KeySalsa");
		reg += KeySalsa.test();
		...
		reg += CAST6.test();
		Log.info.println("Testing claire.util.crypto.cipher.primitive.block.DES");
		reg += DES.test();
		Log.info.println("Testing claire.util.crypto.cipher.primitive.block.TDEA");
		reg += TDEA.test();
		Log.info.println("Testing claire.util.crypto.cipher.primitive.block.DESXs");
		reg += DESX.test();
		...
		reg += FEAL.test();
		Log.info.println("Testing claire.util.crypto.cipher.primitive.block.IDEA");
		reg += IDEA.test();
		Log.info.println("Testing claire.util.crypto.cipher.primitive.block.ARIA");
		reg += ARIA.test();
		Log.info.println("Testing claire.util.crypto.cipher.primitive.block.Camellia");
		reg += Camellia.test();
		Log.info.println("Testing claire.util.crypto.cipher.primitive.block.Speck16");
		reg += Speck16.test();
		Log.info.println("Testing claire.util.crypto.cipher.primitive.block.Speck32");
		reg += Speck32.test();
		Log.info.println("Testing claire.util.crypto.cipher.primitive.block.Speck64");
		reg += Speck64.test();
		Log.info.println("Testing claire.util.crypto.cipher.primitive.block.Simon16");
		reg += Simon16.test();
		Log.info.println("Testing claire.util.crypto.cipher.primitive.block.Simon32");
		reg += Simon32.test();
		Log.info.println("Testing claire.util.crypto.cipher.primitive.block.Simon16");
		reg += Simon64.test();
		Log.info.println("Testing claire.util.crypto.cipher.primitive.block.MARS");
		reg += MARS.test();
		Log.info.println("Testing stream");
		...
		reg += IBAA.testState();
		Log.info.println("Testing claire.util.crypto.cipher.primitive.stream.Salsa");
		reg += Salsa.test();
		Log.info.println("Testing claire.util.crypto.cipher.primitive.stream.Salsa.SalsaState");
		reg += Salsa.testState();
		...
		reg += UInt.test();
		Log.info.println("Testing claire.util.math.SInt");
		reg += SInt.test();
		Log.info.println("Testing claire.util.math.VariableUInt");
		reg += VariableUInt.test();
		Log.info.println("Testing claire.util.math.VariableSInt");
		reg += VariableSInt.test();
		...
		Log.info.println("Testing claire.util.math.SlidingMontgomeryExponentiator");
		reg += SlidingMontgomeryExponentiator.test();
