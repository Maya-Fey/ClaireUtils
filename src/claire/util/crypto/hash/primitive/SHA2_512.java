...
public final class SHA2_512 
	...
	public HashFactory<SHA2_512> factory()
	{
		return factory;
	}
	
	public static final SHA2_512Factory factory = new SHA2_512Factory();
	
	public static final class SHA2_512Factory extends HashFactory<SHA2_512>
	{

		public SHA2_512 build(char[] params, char sep)
		{
			return new SHA2_512();
		}
