...
public abstract class StdInt<Type extends StdInt<Type>> 
	...
	protected abstract void p_add(int[] ints, int len);
	protected abstract void p_subtract(int[] ints, int len);
	protected abstract void p_multiply(int[] ints, int len);
	protected abstract void p_divide(int[] ints, int len);
	protected abstract void p_modulo(int[] ints, int len);
